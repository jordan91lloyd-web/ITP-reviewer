...
export interface ReviewResult {
  ...
  // Action items generated by Claude for the site manager (2–5 items max).
  // Stored in review_data JSON blob — no separate Supabase column required.
...
// A single actionable item generated by Claude for the site manager.
// Stored in review_data.action_items (part of the ReviewResult JSON blob).
