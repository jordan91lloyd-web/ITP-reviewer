...
export default async function Home({
  ...
  // ── Unauthenticated: full-screen landing page ──────────────────────────────
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex flex-col">
        {/* Top nav */}
        <nav className="bg-[#1F3864] px-6 py-4">
          <div className="mx-auto max-w-5xl flex items-center justify-between">
            <div>
              <span className="text-[#D97706] font-bold text-lg">Fleek</span>
              <span className="text-white font-bold text-lg"> Constructions</span>
            </div>
            <Link
              href="/how-it-works"
        ...
        <section className="bg-gray-50 flex-1 px-6 pb-16">
