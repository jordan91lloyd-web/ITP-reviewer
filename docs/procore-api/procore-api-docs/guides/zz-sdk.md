...
Source: https://developers.procore.com/documentation/sdk
...
It authenticates with Procore's API using the [OAuth 2.0 Authorization Code Grant Type](062-oauth-auth-grant-flow.md) flow.
