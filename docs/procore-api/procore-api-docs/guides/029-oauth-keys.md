...
Source: https://developers.procore.com/documentation/oauth-keys
...
See [Promoting a Sandbox Manifest to Production](023-building-apps-promote-manifest.md) for additional information.
...
![Sandbox Account screenshot](https://developers.procore.com/documentation/assets/guides/form-based-sandbox-oauth-creds.png)
...
![App Credentials screenshot](https://developers.procore.com/documentation/assets/guides/form-based-production-oauth-creds.png)
