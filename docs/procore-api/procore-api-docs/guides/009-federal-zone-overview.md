# Procore's Federal Environment

_Learn how the Federal Zone differs from Procore’s Commercial environment and what developers need to know._

Source: https://developers.procore.com/documentation/federal-zone-overview
...
<p>
  Email [marketplaceqa@procore.com](mailto:marketplaceqa@procore.com) with the following details:
</p>
<ul>
...
- [Handling Procore Regions](008-tutorial-mpz.md)
- [Choosing an OAuth 2.0 Grant Type](014-oauth-choose-grant-type.md)

For questions or support, contact [marketplaceqa@procore.com](mailto:marketplaceqa@procore.com).
