# Filtering and Sorting on List Actions

Source: https://developers.procore.com/documentation/filtering-on-list-actions
...
See [Working with Daily Logs](041-daily-logs.md) for additional information.
