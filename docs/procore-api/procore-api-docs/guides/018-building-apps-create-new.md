...
_Set up your account, build your first app, and configure your App Manifest to start developing in Procore._

Source: https://developers.procore.com/documentation/building-apps-create-new
...
1. Open your browser and go to the [Developer Portal](https://developers.procore.com/developers).
...
1. Go to the [Developer Portal](https://developers.procore.com/developers) and sign in to your account.
...
For step-by-step instructions on installing a version in the Developer Sandbox, see [Install a Version in Your Developer Sandbox](022-install-version-sandbox.md).
...
- [Data Connector Apps](019-building-data-connection-apps.md) (User Level or Service Account Authentication)
- [Embedded Apps](020-building-embedded-apps.md) (Full Screen or Side Panel)
...
For more information on app versions, see [App Versioning and Update Notifications](023-building-apps-promote-manifest.md).

***
## See Also
- [Managing App Collaborators](028-building-apps-manage-collabs.md)
- [Available App Types](013-building-apps-app-types.md)
- [Managing App Versions & Update Notifications](023-building-apps-promote-manifest.md)
- [Verification & Production Access](002-verification-and-production-access.md)
