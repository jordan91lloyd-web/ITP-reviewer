...
_Format dates, times, time zones, and ISO country and state codes correctly in Procore API requests._

Source: https://developers.procore.com/documentation/date-time
...
Here is a [downloadable JavaScript example](https://developers.procore.com/documentation/assets/static/datetime-get-sample-code.html) that helps illustrate how the rendering of date/time values might be handled in a single-page JavaScript application.
...
See our [Filtering and Sorting Guide](068-filtering-on-list-actions.md) for additional tips on working with responses from Procore API GET requests.
...
Here is a [downloadable JavaScript example](https://developers.procore.com/documentation/assets/static/datetime-post-sample-code.html) that helps illustrate how to properly include date/time data in the request body in the context of a single-page JavaScript application.
...
- [Filtering & Sorting](068-filtering-on-list-actions.md)
