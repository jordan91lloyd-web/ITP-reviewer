# Developer Managed Service Accounts (DMSA)

_Learn how DMSAs provide secure, automated API access without traditional service accounts._

Source: https://developers.procore.com/documentation/developer-managed-service-accounts
...
![Add Permitted Projects](https://developers.procore.com/documentation/assets/guides/dmsa-add-permitted-projects-modal.png)
...
See [Using Developer Managed Service Accounts with MPR](https://developers.procore.com/documentation/oauth-client-credentials#using-developer-managed-service-accounts-with-mpr) for additional information.

### How do we see which companies have the App installed?

Installation metrics are captured and available for viewing and downloading from your application page on the Procore Developer Portal. See [Manage & Improve Your Marketplace App](032-update-your-marketplace-app.md) for additional information.
