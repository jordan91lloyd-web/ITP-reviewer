...
_Learn about the various fields accessible on your public Marketplace listing and their requirements._

Source: https://developers.procore.com/documentation/marketplace-listing-guidelines
...
You can access the **Marketplace Listing** section through the left navigation menu inside your app, within the [Procore Developer Portal](https://developers.procore.com/developers).
...
![Marketplace Logo Examples](https://developers.procore.com/documentation/assets/guides/app-marketplace-logo-examples.png)
...
![Marketplace Screenshot Examples](https://developers.procore.com/documentation/assets/guides/app-marketplace-screenshot-examples.png)
...
- **Disallow Installations (NEW):** If your app requires significant setup, support, or training, you may choose to disable direct installations. 
    - This approach allows your team to manage the onboarding process more carefully as the customer would need to reach out to your team directly to learn how to install the app. This process would utilize the [Custom App Install](https://support.procore.com/products/online/user-guide/company-level/admin/tutorials/install-a-custom-app) workflow, where you would be responsible for providing the customer with the App Install Key.

![Marketplace Engagement Examples](https://developers.procore.com/documentation/assets/guides/app-marketplace-engagement-examples.png)
