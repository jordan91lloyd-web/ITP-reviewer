...
Source: https://developers.procore.com/documentation/tutorial-timecard-entries
...
![timecard-integration-workflow](https://developers.procore.com/documentation/assets/guides/timecard-integration-workflow.png)
...
![list-cost-codes-response](https://developers.procore.com/documentation/assets/guides/list-cost-codes-response.png)
...
![create-timecard-entry](https://developers.procore.com/documentation/assets/guides/create-timecard-entry.png)
...
![create-timesheet-to-budget-config](https://developers.procore.com/documentation/assets/guides/create-timesheet-to-budget-config.png)
...
![timecard-entry-hours](https://developers.procore.com/documentation/assets/guides/timecard-entry-hours.png)
...
- [Observations](043-tutorial-observations.md)
