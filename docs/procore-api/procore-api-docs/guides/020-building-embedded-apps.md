...
_Build an app that runs inside Procore's UI — as a full screen workspace or a contextual side panel._

Source: https://developers.procore.com/documentation/building-embedded-apps
...
You can add one or both to a single app. To get started, first [create a Developer Portal account and app](018-building-apps-create-new.md).
...
4. (Optional) Add dynamic URL parameters so your app adapts to each company, project, or install. See [Understanding URL Parameter Interpolation](069-building-apps-url-parameter-interpolation.md).
...
6. (Optional) Add dynamic URL parameters so your app adapts to each company, project, or install. See [Understanding URL Parameter Interpolation](069-building-apps-url-parameter-interpolation.md).
7. Click **Save Component**.

For the full list of supported view keys and URL patterns, see the [Side Panel View Key Reference](070-side-panel-view-keys.md).
...
3. Enter a semantic version number (e.g., `0.1.0`). Versions must be three integers separated by dots (`x.x.x`).
   - For details, see [App Versioning &amp; Production](023-building-apps-promote-manifest.md).
4. Click **Create**.
...
Test each version of your app in your Developer Sandbox before promoting it to production. See [Install a Version in Your Developer Sandbox](022-install-version-sandbox.md).

***
## Promote to Production
Once you're satisfied with testing, promote your sandbox version to production. See [App Versioning &amp; Production](023-building-apps-promote-manifest.md) to learn how.
