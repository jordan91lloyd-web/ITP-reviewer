# Working with File Attachments and Image Uploads

Source: https://developers.procore.com/documentation/attachments
...
![Direct File Upload](https://developers.procore.com/documentation/assets/guides/postman-direct-file-upload.png)
...
![Accident log request example](https://developers.procore.com/documentation/assets/guides/accident-log-direct-upload-request.png)
...
![Create Image request example](https://developers.procore.com/documentation/assets/guides/attachments-images-request-example.png)
