...
Source: https://developers.procore.com/documentation/tutorial-direct-drawing-uploads
...
![list-drawing-areas](https://developers.procore.com/documentation/assets/guides/drawing-area-id.png)
...
![create-drawing-resp](https://developers.procore.com/documentation/assets/guides/create-drawing-resp.png)
...
For detailed instructions on these steps, see [Direct File Uploads](048-tutorial-uploads.md).
...
![create-drawing-upload](https://developers.procore.com/documentation/assets/guides/create-drawing-upload.png)
...
![ready-for-review](https://developers.procore.com/documentation/assets/guides/ready-for-review.png)
...
- [Working with Direct File Uploads](048-tutorial-uploads.md) — general information on creating file uploads using the Procore API
