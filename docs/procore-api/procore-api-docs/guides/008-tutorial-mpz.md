...
Source: https://developers.procore.com/documentation/tutorial-mpz
...
![MPR Architecture Diagram - 01](https://developers.procore.com/documentation/assets/guides/auth-and-MPZ-diag-1.png)
...
See [Using Service Accounts with MPR](063-oauth-client-credentials.md#using-service-accounts-with-mpz) for additional information.
...
For sandbox environment URLs and setup details, see [Sandbox Environments](006-development-environments.md).
