# Working with the Correspondence Tool

Source: https://developers.procore.com/documentation/tutorial-correspondence
...
![Correspondence Tool Objects](https://developers.procore.com/documentation/assets/guides/correspondence-tool-objects.png)
...
![List Generic Tools](https://developers.procore.com/documentation/assets/guides/list-generic-tools.png)
...
2.  From the Project Tools menu, choose Correspondence under Project Management.
    ...
    ![Correspondence menu item](https://developers.procore.com/documentation/assets/guides/corres-menu-item.png)
...
3.  On the Correspondence page, open the **Create** menu and examine the list available Correspondence Types in the dropdown.
    ...
    ![Create Correspondence](https://developers.procore.com/documentation/assets/guides/corres-create-menu.png)
...
![List Correspondence Type Users](https://developers.procore.com/documentation/assets/guides/list-corres-type-users.png)
...
![List Correspondence Type Permissions](https://developers.procore.com/documentation/assets/guides/list-corres-type-perms.png)
...
![Create Generic Tool Item](https://developers.procore.com/documentation/assets/guides/create-generic-tool-item.png)
...
![List Correspondence Items Filtered](https://developers.procore.com/documentation/assets/guides/list-corres-items-filter.png)
...
![Show Generic Tool Item](https://developers.procore.com/documentation/assets/guides/show-generic-tool-item.png)
...
![Create Item Response](https://developers.procore.com/documentation/assets/guides/create-corres-item-response.png)
...
See [Working with File Attachments and Image Uploads](047-attachments.md) for information on using file attachments with the Procore API.
...
![Bulk Update Correspondence Items](https://developers.procore.com/documentation/assets/guides/batch-update-corres-items.png)

## Correspondence Webhooks
The Correspondence tool supports webhooks as described in [Introduction to Webhooks](016-webhooks.md) and [Using the Webhooks API](021-webhooks-api.md). Procore customers can configure Correspondence webhooks using the Project Admin tool as outlined in [Configure Project Webhooks](https://support.procore.com/products/online/user-guide/project-level/admin/tutorials/configure-webhooks).
...
- [Working with Configurable Fieldsets](054-tutorial-config-fieldsets.md)
- [Working with User Permissions and Permission Templates](055-tutorial-user-permissions.md)
- [Work Breakdown Structure](056-tutorial-wbs.md)
- [Interacting with Workflows](057-tutorial-workflows-v2.md)
- [Interacting with Workflows (Legacy)](058-tutorial-workflows.md)
