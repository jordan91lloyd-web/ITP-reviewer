...
Source: https://developers.procore.com/documentation/building-apps-versioning
...
<html>
  ...
  <body>
    <p>If you are not redirected, [click here](/documentation/building-apps-promote-manifest).</p>
  </body>
</html>
...
The version numbers for your application are managed in the App Manifest. See [Create an App Manifest](building-apps-define-manifest.md) for additional information.
