...
Source: https://developers.procore.com/documentation/marketplace-policy
...
<ol type="a" class="alpha">
  ...
  <li>Violate the [Procore Brand Guidelines](https://brand.procore.com) or [Procore Trademark Use Guidelines](https://www.procore.com/legal/trademark).</li>
...
If API Data is breached, exposed, exploited, or otherwise compromised through your Application or company, you must immediately inform all affected Customers and Procore in accordance with the API Terms. Please contact us at [security@procore.com](mailto:security@procore.com) immediately.
