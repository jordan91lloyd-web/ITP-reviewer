...
Source: https://developers.procore.com/documentation/tutorial-workflows-v2
...
> If you are working with the **legacy Workflows tool** — the `workflow_instances` and `workflow_activity_histories` endpoints, still supported — see [Interacting with Workflows (Legacy)](058-tutorial-workflows.md) instead. The two tools have different APIs, not different versions of one API.
...
![API Record Diagram](https://developers.procore.com/documentation/assets/guides/workflows-v2-api-records-diagram.png)
