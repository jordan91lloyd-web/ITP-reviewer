# Interacting with Workflows (Legacy)

Source: https://developers.procore.com/documentation/tutorial-workflows
...
> If you are building against the **company-level Self-Serve Workflows tool** — templates, presets, and instances, with their own separate endpoints — see [Interacting with Workflows](057-tutorial-workflows-v2.md) instead. The two tools have different APIs, not different versions of one API.
...
![Example Workflow](https://developers.procore.com/documentation/assets/guides/example-workflow.svg)
