# Install a Version in Your Developer Sandbox

_Install an app version in your Developer Sandbox so you can test how Procore users will experience your app before promoting it to production._

Source: https://developers.procore.com/documentation/install-version-sandbox

---

## Overview
> **These steps cover the Developer Sandbox,** which uses the Sandbox App Version Key. To test in a customer's On-Demand or Monthly Sandbox, install with the **Production** App Version Key instead. See [Procore Sandboxes](006-development-environments.md).
...
***
## Next Steps
Once the version behaves as expected in your sandbox, promote it to make it available for production use. See [App Versioning &amp; Production](023-building-apps-promote-manifest.md).
