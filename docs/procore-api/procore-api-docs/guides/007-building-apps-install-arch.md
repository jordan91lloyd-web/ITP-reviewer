# How to Install & Set Up Apps

_Understand installation, post-install notes, configurations, and permissions for data connector and embedded apps._

Source: https://developers.procore.com/documentation/building-apps-install-arch
...
<!-- Setup path chooser -->
  ...
  Jump to: [Data Connector](#data-connector) · [Embedded](#embedded-apps)
...
<details>
  ...
  ![Post Install Steps](https://developers.procore.com/documentation/assets/guides/app-install-instructions-final.png)
...
- [Create an App](building-apps-intro.md)
