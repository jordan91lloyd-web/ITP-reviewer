# Integrating with Procore Financial Tools

Source: https://developers.procore.com/documentation/tutorial-financial-tools
...
> To get started, see our [API introduction](001-introduction.md).
...
Many clients choose to implement an on-premise architecture, however please be aware that to leverage the [API Webhooks](016-webhooks.md), your application will need to allow incoming connections from the public internet.
...
To connect with a Solutions Architect from Procore regarding your integration, please visit the [Technical Services](tech-services.md) page and fill out the available request form.
...
For more information, see the [Sync Actions](072-using-sync-actions.md) guide.
...
![external vendor ids](https://developers.procore.com/documentation/assets/guides/financials-ext-id-vendors.svg)
![external vendor commit](https://developers.procore.com/documentation/assets/guides/financials-ext-id-vendor-commit.svg)
...
![external commit id](https://developers.procore.com/documentation/assets/guides/financials-commit-ext-id.svg)
...
![external cco id](https://developers.procore.com/documentation/assets/guides/financials-ext-cco-id.svg)
...
![commit listing](https://developers.procore.com/documentation/assets/guides/financials-commit-list.svg)

#### Project Listing

![project listing](https://developers.procore.com/documentation/assets/guides/financials-project-list.svg)

#### Directory Listing

![vendor listing](https://developers.procore.com/documentation/assets/guides/financials-dir-list.svg)

### Prime Contract Show

![vendor listing](https://developers.procore.com/documentation/assets/guides/financials-prime-show.svg)
...
![direct cost locking](https://developers.procore.com/documentation/assets/guides/financials-direct-cost-locking.svg)
...
See the [legacy Workflows API](058-tutorial-workflows.md) guide, or [Interacting with Workflows](057-tutorial-workflows-v2.md) for the company-level Self-Serve Workflows tool.
...
Please see the [Webhooks API](016-webhooks.md) guide for additional information.

## See Also

- [Budget Tools](037-tutorial-budget-line-items.md)
- [Budget Changes API](038-tutorial-budget-changes-api.md)
- [Change Orders](039-tutorial-change-orders.md)
