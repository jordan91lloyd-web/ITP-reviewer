...
_Learn how to build and test your first Procore app._

Source: https://developers.procore.com/documentation/quick-start-guide
...
***
## Things to Consider
- A Procore Developer Account (email verified) is required. See [Registering a New Developer Account](new-account.md).
- You should have a basic understanding of OAuth 2.0 (authorization code flow) and redirect URIs.
- You will need an API client such as [Postman](https://www.postman.com/) or [cURL](https://curl.se/).

<details>
<summary class="collapseListH2">Step 1: Create Your App in the Developer Portal</summary>
<p>
  <ol>
    <li>Sign in to the [Procore Developer Portal](https://developers.procore.com/developers).</li>
...
<p>
  Each app includes a Developer Sandbox for testing. Only the App Creator is added by default. To add testers, see [Add a User Account to the Company Directory](https://support.procore.com/products/online/user-guide/company-level/directory/tutorials/add-a-user-account-to-the-company-directory).
  <ol>
...
<p>
  ...
  For more endpoints, see the [REST API Overview](https://developers.procore.com/reference/rest/docs/rest-api-overview).
</p>
</details>
...
- **Plan your integration:** [Available App Types](013-building-apps-app-types.md)
- **Explore the full API:** [REST API Reference](https://developers.procore.com/reference/rest/docs/rest-api-overview)
- **Set up webhooks:** [Introduction to Webhooks](016-webhooks.md)
- **Publish to the Marketplace:** [Technology Partner Overview](030-procore-partner-overview.md)
- **Run into an issue?** [Troubleshooting](026-troubleshooting.md)
