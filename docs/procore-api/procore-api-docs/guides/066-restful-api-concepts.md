...
_How Procore API requests and responses are structured — transport, supported methods, JSON payloads, and user IDs._

Source: https://developers.procore.com/documentation/restful-api-concepts
...
For status codes and error responses, see [Error Code Reference](073-error-reference.md).
For versioning and URL structure, see [REST API Overview](065-rest-api-overview.md).
...
- [Dates, Times, and Country Codes](071-date-time.md)
