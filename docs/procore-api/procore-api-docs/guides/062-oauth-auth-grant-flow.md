...
_Implement the Authorization Code grant for web apps and installed apps._

Source: https://developers.procore.com/documentation/oauth-auth-grant-flow

---

## Overview

> **Before you begin.** Confirm the Authorization Code grant fits your use case before you implement it. See [Choose an Authentication Method](014-oauth-choose-grant-type.md) and [Authentication Endpoints](064-oauth-endpoints.md).
...
![Diagram](https://developers.procore.com/documentation/assets/guides/auth-code-grant-type-activity-diagram.png)
...
![OAuth code](https://developers.procore.com/documentation/assets/guides/oauth-code.png)
...
- [Authentication Endpoints](064-oauth-endpoints.md) — full parameter reference for `/oauth/authorize`, `/oauth/token`, `/oauth/token/info`, and `/oauth/revoke`.
- [OAuth Credentials Management](029-oauth-keys.md) — where to find Client ID and Client Secret in the Developer Portal.
