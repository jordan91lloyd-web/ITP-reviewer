...
Source: https://developers.procore.com/documentation/tutorial-observations
...
| Quality              | - _Corrective Action_ - items that need to be completed to correct or rectify an issue.
- _Deficiency_ - work that was not completed to professional standards or wasn't up to an acceptable level of quality.
- _Non-Conformant_ - work that does not conform to the approved plans.
- _Pre-Punch_ - punch list items that need to be fixed before the official punch list is created with the owner/architect.                                                                  |
...
- _Safety Hazard_ - a hazardous condition that exists on site.
- _Safety Notice_ - a verbal or written warning given to a person or company because he or she was behaving in an unsafe way.
- _Safety Violation_ - a behavior or negligence on the part of a person that violates safety policies or safety laws and regulations. |
...
You can add an attachment to an observation item following the process outlined in [Working with File Attachments and Image Uploads](047-attachments.md).
...
![Observation Attachment](https://developers.procore.com/documentation/assets/guides/observation-attachment-example.png)
...
- [Daily Logs](041-daily-logs.md)
- [Incidents](042-tutorial-incidents.md)
- [Timesheets & Timecards](044-tutorial-field-prod.md)
- [Timecard Entries](045-tutorial-timecard-entries.md)
