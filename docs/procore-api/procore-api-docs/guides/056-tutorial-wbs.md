...
Source: https://developers.procore.com/documentation/tutorial-wbs
...
![Custom Segment - UI](https://developers.procore.com/documentation/assets/guides/wbs-segments-phase.png)
...
View the [WBS Primer for Partners and Integrators](https://developers.procore.com/documentation/assets/static/WBS_Primer_V1_03.31.2022.pdf) for detailed information.
...
![Legacy Budget Code](https://developers.procore.com/documentation/assets/guides/wbs-legacy-budget-line.png)

**WBS**:

![WBS Budget Code](https://developers.procore.com/documentation/assets/guides/wbs-code-budget-line.png)
...
- [Working with the Correspondence Tool](053-tutorial-correspondence.md)
