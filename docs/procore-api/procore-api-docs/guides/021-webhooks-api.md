...
_Quick start to creating hooks, adding triggers, and monitoring deliveries._

Source: https://developers.procore.com/documentation/webhooks-api

---

## Overview

> **New to webhooks?** This page is the implementation guide — a quick start for setting up hooks, triggers, and deliveries via the API. For background concepts, event payloads, and how delivery works, see [How Webhooks Work](016-webhooks.md).
...
- [Introduction to Webhooks](016-webhooks.md)
