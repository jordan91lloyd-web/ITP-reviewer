...
Source: https://developers.procore.com/documentation/building-agentic-apps
...
An app can declare either or both of the agentic components below, alongside any Embedded or Data Connector components. For how they fit among the app families, see [Choose an App Type](013-building-apps-app-types.md).
...
Procore AI keeps a person in control: every action an agent proposes is **staged for review and approval** before anything changes in Procore, and the AI cites its sources. For the customer-facing overview, see [About Procore AI](https://v2.support.procore.com/product-manuals/procore-ai/tutorials/about-procore-ai).
...
***
## Next Steps
- [Choose an App Type](013-building-apps-app-types.md) — how Agentic fits among the app families.
- [Create an App](018-building-apps-create-new.md) — start an app and its manifest.
- [About Procore AI](https://v2.support.procore.com/product-manuals/procore-ai/tutorials/about-procore-ai) — the customer experience your capabilities surface in.
