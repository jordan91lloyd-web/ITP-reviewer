...
Source: https://developers.procore.com/documentation/listing-your-app
...
<html>
  ...
  <body>
    <p>If you are not redirected, [click here](/documentation/procore-partner-overview).</p>
  </body>
</html>

<!-- Retired 2026-05-28. Content consolidated to avoid duplication and a contradictory partner-journey sequence:
       - Partner journey, vetting, and agreement  -> Technology Partner Overview (/procore-partner-overview)
       - Listing fields and best practices         -> Marketplace Listing Guidelines (/marketplace-listing-guidelines)
       - Submission and validation process         -> Marketplace Approval Checklist (/marketplace-checklist)
     The Partner Code of Conduct link was relocated to the Technology Partner Overview. The Partner Program benefits list was dropped (the Partner Program Guide owns it).
...
To learn more about our Technology Partner Program, including benefits and partner tiers, view the Partner Program Guide.
...
To review the agreements and expectations in advance, see the Framework Agreement & Tech Partner Addendum and the Partner Code of Conduct.
...
For full field explanations and requirements, see the Marketplace Listing Guidelines.
...
For additional validation details, see the Marketplace Approval Checklist.
-->
