...
_Understand your verification status and what it unlocks in the Developer Portal._

Source: https://developers.procore.com/documentation/verification-and-production-access
...
2. **Request production credentials per app** — After your organization is verified, each app you want to promote to production requires its own approval. This ensures every app meets Procore's [API Terms of Use](https://procore.pactsafe.io/legal.html#contract-hymckkfc9) and [User Terms of Service](https://procore.pactsafe.io/legal.html#contract-syqj4fbct) before production credentials are issued.
...
**To get verified:** Select **Apply to Become a Marketplace Partner** from the Developer Portal. You will receive an email notification with next steps when your review is complete. See the [Partner & Marketplace Overview](030-procore-partner-overview.md) for requirements and listing details.
...
- [App Versioning & Production](023-building-apps-promote-manifest.md)
- [Partner & Marketplace Overview](030-procore-partner-overview.md)
- [Create an App](018-building-apps-create-new.md)
