...
_Understand how versioning impacts your app’s lifecycle, and how updates are surfaced to Procore users._

Source: https://developers.procore.com/documentation/building-apps-promote-manifest
...
[image: https://developers.procore.com/documentation/assets/guides/manifest-promotion.png]
</details>
...
> **Before you can promote to production,** your organization must be verified. If you see a **Become a Verified Developer** prompt instead of production options, complete the verification process first. See [Verification & Production Access](002-verification-and-production-access.md) for the two available paths.
...
![App Update Available](https://developers.procore.com/documentation/assets/guides/update-available-badge.png)

See [Update an Installed App](https://v2.support.procore.com/product-manuals/admin-company/tutorials/update-installed-app) for more information.
