# ERP Events Dictionary

Source: https://developers.procore.com/documentation/erp-events-dictionary
...
The event notification payload is documented in [Set Up Webhooks](021-webhooks-api.md).
...
1. Setting the **origin_id** values on the external data record here: [Rest API Overview](https://developers.procore.com/reference/rest/v1/erp-external-data?version=1.0#sync-external-data) 

    **item_type=contract_payment** and **item_id** is the **id** value of the contract payment export 
